...
| Reports | Instructor report data endpoint | implemented-api | `GET /reports/students` rebuilds the WordPress status logic and returns rows plus summary counts. Excel/PDF UI is still pending. |
