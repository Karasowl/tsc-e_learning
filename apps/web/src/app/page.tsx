...
<style>
  * { box-sizing: border-box; }
  body { font-family: Arial, Helvetica, sans-serif; color: #15191c; margin: 24px; }
  header { display: flex; align-items: center; gap: 14px; border-bottom: 3px solid #0d161a; padding-bottom: 12px; margin-bottom: 16px; }
  header img { height: 54px; }
  header h1 { margin: 0; font-size: 20px; letter-spacing: 0.3px; }
  header p { margin: 2px 0 0; color: rgba(21, 25, 28, 0.6); font-size: 12px; }
  .summary { display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 16px; }
  .card { border: 1px solid #cbc7be; border-radius: 8px; padding: 8px 12px; min-width: 120px; }
  .card span { display: block; color: rgba(21, 25, 28, 0.6); font-size: 11px; text-transform: uppercase; letter-spacing: 0.06em; }
  .card strong { font-size: 20px; }
  table { width: 100%; border-collapse: collapse; font-size: 12px; }
  th { background: #0d161a; color: #fff; text-align: left; padding: 8px; font-size: 11px; text-transform: uppercase; letter-spacing: 0.06em; }
  td { border-bottom: 1px solid #e0ddd4; padding: 7px 8px; vertical-align: top; }
  td.num { text-align: right; white-space: nowrap; }
  small { color: rgba(21, 25, 28, 0.6); }
  .toolbar { text-align: right; margin-bottom: 12px; }
  .toolbar button { background: #a82431; color: #fff; border: 0; border-radius: 999px; padding: 9px 18px; font-weight: 700; cursor: pointer; }
